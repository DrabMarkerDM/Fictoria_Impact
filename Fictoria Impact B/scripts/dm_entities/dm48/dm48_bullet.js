    ...
    dm48_s_ak: (target, attacker, projectile, dimension, runEffectCommands, hitLocation) => {
        if (Math.random() < 0.05) {
            ...
            runEffectCommands(dimension, hitLocation, [
                ...
                "playsound dm.ak_shoot @a[r=33] ~~~ 2.8 1.5",
                "execute at @e[tag=!dm,family=monster,r=8,c=4] run particle dm:dm48_satt ^0.3 ^2 ^",
                "execute at @e[tag=!dm,family=monster,r=8,c=4] run particle dm:dm48_satt ^ ^2.1 ^",
                "execute at @e[tag=!dm,family=monster,r=8,c=4] run particle dm:dm48_satt ^ ^2 ^0.2"
            ]);
        }
    },
    ...
    dm48_ak: (target, attacker, projectile, dimension, runEffectCommands, hitLocation) => {
        if (Math.random() < 0.03) {
            ...
            runEffectCommands(dimension, hitLocation, [
                ...
                "playsound dm.ak_shoot @a[r=33] ~~~ 2.8 1.4",
                "execute at @e[tag=!dm,family=monster,r=8,c=4] run particle dm:dm48_att ^0.3 ^2 ^",
                "execute at @e[tag=!dm,family=monster,r=8,c=4] run particle dm:dm48_att ^ ^2.1 ^",
                "execute at @e[tag=!dm,family=monster,r=8,c=4] run particle dm:dm48_att ^ ^2 ^0.2"
            ]);
        }
    }
};
